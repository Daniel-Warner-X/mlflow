...
/**
 * A custom split button to select versions to compare in the tool details page.
 */
export const ToolVersionsDiffSelectorButton = ({
  ...
  return (
    ...
    >
      <div css={{ display: 'flex', height: theme.general.buttonInnerHeight + theme.spacing.xs, gap: 0, flex: 1 }}>
        <Tooltip
          componentId="mlflow.tool-registry.details.select_baseline.tooltip"
          content={
            <FormattedMessage
              defaultMessage="Select as baseline version"
              description="Label for selecting baseline tool version in the comparison view"
            />
          }
          delayDuration={0}
          side="left"
        ...
        <Tooltip
          componentId="mlflow.tool-registry.details.select_compared.tooltip"
          content={
            <FormattedMessage
              defaultMessage="Select as compared version"
              description="Label for selecting compared tool version in the comparison view"
            />
          }
          delayDuration={0}
          side="right"
